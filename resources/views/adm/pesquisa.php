    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto text-center">
          <h1 class="title">Sua opinião é ben importante!</h1>
          <br>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="atendimento" id="valor1" value="otimo"> Ótimo
                  <span class="circle">
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="atendimento" id="valor2" value="bom" checked=""> Bom
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check disabled">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="atendimento" id="valor3" value="medio" checked=""> Médio
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check disabled">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="atendimento" id="valor4" value="ruim" checked=""> Ruim
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
            ...
            <div class="col-md-4">
              <div class="title">
                <h3>Como estava sua comida?</h3>
              </div>
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="comida" id="valor5" value="otimo"> Ótimo
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="comida" id="valor6" value="bom" checked=""> Bom
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check disabled">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="comida" id="valor7" value="medio" checked=""> Médio
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check disabled">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="comida" id="valor8" value="ruim" checked=""> Ruim
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
            ...
            <div class="col-md-4">
              <div class="title">
                <h3>Como estava o ambiente?</h3>
              </div>
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="ambiente" id="valor9" value="otimo"> Ótimo
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="ambiente" id="valor10" value="bom" checked=""> Bom
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check disabled">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="ambiente" id="valor11" value="medio" checked=""> Médio
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
              ...
              <div class="form-check disabled">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="ambiente" id="valor12" value="ruim" checked=""> Ruim
                  <span class="circle">
                    <span class="check"></span>
                  </span>
                </label>
          ...
          <div class="row">
          <br>
          <h3>Quer deixar um comentario sobre o seu atendimento?</h3>
        </div>
