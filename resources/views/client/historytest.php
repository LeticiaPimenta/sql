        ...
        <div class="col-md-12">
              <div id="accordion" role="tablist" ng-repeat="origins in carts_origin">
                <div class="card card-collapse">
                  ...
                  <div id="collapse-{{products_id[item.shop].$id}}" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body" ng-repeat="item in origins">
