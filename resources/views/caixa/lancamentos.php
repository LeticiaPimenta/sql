...
<script type="text/javascript">
  ...
  var ref_carts = firebase.database().ref().child("lancamentos/<?php echo $loja;?>");
  // create a synchronized array
                    ...
                    <tbody ng-repeat="items in origins">
                      <tr ng-repeat="(key,item) in items">
                        ...
                        <td class="td-actions text-right">
                          ...
                          <button type="button" rel="tooltip" class="btn btn-danger btn-just-icon btn-sm" data-original-title="" title="" ng-click="modalPedido(product.$id,product.text,product.value)" data-toggle="modal" data-target="#smallAlertModal">
