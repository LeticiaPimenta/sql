                ...
                <div class="row collections">
                  <div class="col-md-3">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 200px;">
                      ...
                      <div class="card-body" ng-click="modal_credito(10)">
                        <a href="#">
                          <h2 class="card-title">R$ 10,00</h2>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 200px;">
                      ...
                      <div class="card-body" ng-click="modal_credito(20)">
                        <a href="#">
                          <h2 class="card-title">R$ 20,00</h2>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 200px;">
                      ...
                      <div class="card-body" ng-click="modal_credito(50)">
                        <a href="#">
                          <h2 class="card-title">R$ 50,00</h2>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 200px;">
                      ...
                      <div class="card-body" ng-click="modal_credito(100)">
                        <a href="#">
                          <h2 class="card-title">R$ 100,00</h2>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-3" style="width: 45%; margin-left: 17px;">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 140px; margin: auto;">
                      ...
                      <div class="card-body" ng-click="modal_credito(10)">
                        <a href="#">
                          <h3 class="card-title">R$ 10,00</h3>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3" style="width: 45%; margin-left: 10px;">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 140px; margin: auto;">
                      ...
                      <div class="card-body" ng-click="modal_credito(20)">
                        <a href="#">
                          <h3 class="card-title">R$ 20,00</h3>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3" style="width: 45%; margin-left: 17px;">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 140px;">
                      <a href="#"></a>
                      <div class="card-body" style="padding-left: 10px;" ng-click="modal_credito(50)">
                        <a href="#">
                          <h3 class="card-title">R$ 50,00</h3>
                        </a>
                      </div>
                    </div>
                  </div>
...
<div class="modal fade" id="modal_produto" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" style="margin-top: auto;">Voucher de R$ {{credito_selecionado}}</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="material-icons">clear</i>
          </button>
        </div>
        <div class="modal-body">
          <h4>Adquira um voucher de R$ {{credito_selecionado}} para utilizar em suas compras ou transferir para seus amigos! </h4>
