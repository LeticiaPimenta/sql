    ...
    <div class="page-header header-filter" filter-color="warning" style="background-image: url('../assets/img/benjamin4.jpg'); background-size: cover; background-position: top center;">
      <div class="container" style="margin-top: auto;">
        <div class="row">
          <div class="col-md-6 ml-auto mr-auto" style="margin-block-end: 70px;">
            <div class="card card-signup" id="container-registrado" style="display: none">
              <h2 class="card-title text-center">Cadastro com sucesso!</h2>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 mr-auto">
                    <div class="container">
                      <br><br>
                      <h2>Você foi registrado com sucesso!</h2>
                      <br><br>
                      <a href="/login">
                      <div class="btn btn-warning btn-round">Faça seu login.</div></a>
                    </div>
                  </div>
                </div>
              </div>
            </div>
              <div class="row" id="form_facebook">
                <div class="col-md-12 mr-auto">
                  <div class="card card-profile" style="margin-top: 130px!important;">    
                    <div class="avatar">
                  ...
                  <h2 class="card-title text-center">Conectar sua conta do Facebook</h2>

                  <div class="col-md-11">
                    <form class="form" id="registrar_form"  style="display: none;" >
                      ...
                      <div class="text-center">
                        ...
                        <div  class="btn btn-warning btn-round" id="registrar">Registrar</div>
                      </div>

                    </form>
                    <div id="conectar_facebook" ng-click="login_facebook()" class="btn btn-warning btn-round">Buscar Dados</div>
                  </div>
                  </div>
                </div>
                </div>
