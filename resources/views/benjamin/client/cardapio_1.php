...
<!--          <div class="col-md-3" id="1" ng-repeat="product in produtos_campanha">
    ...
    <div class="section">
      <div class="container" id="3">
        <h2 class="section-title">{{nome}}</h2>
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-3" ng-repeat="product in produtos_campanha">
                ...
                <div class="row collections">
                  ...
                  <div class="col-md-3">
                    <div class="card card-background" style="background-image: url('/assets/img/Paes.jpg'); height: 200px;">
                      ...
                      <div class="card-body">
                        <a href="#">
                          <h2 class="card-title">Mix Padaria</h2>
                        </a>
                      </div>
                    </div>
                  </div> -->
