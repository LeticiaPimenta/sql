      ...
      <div class="card card-plain">
         <div class="card-body">
            ...
            <div class="table-responsive">
                  ...
                  <tbody >
                     <tr ng-repeat="(hash ,carrinho) in carts">
                        ...
                        <td>
                              ...
                              {{carrinho.valor}} 
                              <a href="/caixa/nota/{{carrinho.id}}">Ver Nota</a>
               ...
               <a href="/caixa/list/pagamentos">
               <button type="button" class="btn btn-success btn-round" >Pendentes<i class="material-icons">keyboard_arrow_right</i>
               </button>
               </a>
            </div>
         </div>
