<script type="module">
    ...
    function setResult(label, result) {
       ...
       $.post( "/caixa/bater_nota", { nfe: result, pagamento: "<?php echo $pagamento; ?>" })
        .done(function( data ) {
          alert( "Registrado com sucesso");
          window.location.replace("/caixa/list/notas");
        });
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto text-center">
          <h1 class="title">Aponte para o Qr code da nota fiscal</h1>
